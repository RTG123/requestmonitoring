 ...
 <div class="container-fluid">
  <div class="row">
   <div class="col-md-6 col-sm-6 col-xs-12">
      <!-- START FORM -->
    <form action="addrequest/batchupload.php" class="form-horizontal" method="post">
     
      <div class="form-group ">
      <label class="control-label col-sm-2 requiredField" for="date">Date<span class="asteriskField">:</span></label>
      <div class="col-sm-10">
