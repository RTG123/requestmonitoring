...
<html lang="en"> 
    ...
    <head>
        ...
        <!-- ⭐⭐⭐ Link for style of the form ⭐⭐⭐ -->
        <link href="css/formstyle.css" rel="stylesheet">
    </head>

    <body class="fix-header" style="font-family:Century Gothic" onload="<?php echo $_SESSION['New_status'];?>">
     <!-- ⭐⭐⭐ HEADER & SIDE BAR ⭐⭐⭐ -->
        <!-- Preloader -->
        <div class="preloader">
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav slimscrollsidebar">
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li><a href="admin1.php" class="waves-effect active"><i class="mdi mdi-clipboard-outline fa-fw"></i><span class="hide-menu">&emsp;Add Request</span></a></li>
                          ...
                          <form action="database/addformprocess.php" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="input-group">
                                      ...
                                      <div class="input-size">
                                        <input class="form-control" style="width:100%;"
                                          name="date_requested" id="date_requestedmodal" onchange="date_validation()" placeholder="YYYY/MM/DD" type="text"autocomplete="off"/>
                                      </div> 
                                    </div>  
                                  </div>
                                  <!-- Date Received -->
                                  <div class="col-lg-6" id="date2"  >
                                    ...
                                    <div class="input-group">
                                      ...
                                      <div class="input-size">
                                        <input class="form-control"  style="width:100%;"
                                          name="date_received" id="date_receivedmodal" onchange="date_validation()"  placeholder="YYYY/MM/DD" type="text" autocomplete="off"/>
                                      </div> 
                                    </div>
                                  </div>
                                  <!-- Date Registered -->
                                  ...
                                  <div class="col-lg-6" >
                                    <div   id="attach"  >
                                      ...
                                      <div class="input-size">
                                        <input type="file" id="inputattach1" style="padding-bottom:30px; " accept="image/*,.pdf" name="atta" class="form-control" >
                                      </div> 
                                    </div>
                                  </div>
                              </div>
                    ...
                    <div class="modal-dialog" role="document">
                      <div class="modal-content">
                        ...
                        <form action="database/addformprocess.php" method="POST" enctype="multipart/form-data">
                          ...
                          <div class="modal-footer">
                            <button type="button" class="btn btn-danger btn-outline" data-dismiss="modal">Close</button>
                            <button type="submit" name="add_department" class="btn btn-primary"style="background:#008D61;">Save changes</button>
                          </div>
                        </form>
                      </div>
                    </div>
                            ...
                            <div class="form-group">
                              <div   id="DEPT"  >
                                <label>Nature of Request :</label>
                                  <div class="input-size">
                                    <input type="text" id="nature" pattern="[A-Za-z0-9\s]+"  name="nature" title="Special Characters are not allowed in this field"
            ...
            <div class="form">
                  <form action="database/addformprocess.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="col-lg-6"><!--selector -->
                      ...
                      </div><!-- End Date Requested and Date Received-->
                        <!-- details -->
                    ...
                    <div class="col-lg-6" >
                      ...
                      <div class="margin" id="attach">
                        <label>Attachment :</label>
                        <div class="inputfield">
                          <input type="file" id="inputattach" accept="image/*,.pdf" name="atta" class="input" >
                        </div> 
                      </div>
                          <!-- Submit button -->
