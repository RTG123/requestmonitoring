...
<html lang="en">
    ...
    <body class="fix-header" style="font-family:Century Gothic" onload="<?php echo $_SESSION['newstatus'];?>">
     <!-- ⭐⭐⭐ HEADER & SIDE BAR ⭐⭐⭐ -->
        <!-- Preloader -->
        <div class="preloader">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            ...
                            <form action="database/batchupload1.php" method="POST" enctype="multipart/form-data">
        ...
        <!--  add new department -->
          ...
          <!-- divs form header -->
          <div class="form">
            <form action="database/addformprocess1.php" method="POST" enctype="multipart/form-data">
