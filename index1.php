...
<body class="fix-header" style="font-family:Century Gothic" onload="<?php echo $_SESSION['Status'];?>">
                         ...
                         <!-- ⭐⭐⭐ NOTIFICATION ⭐⭐⭐-->
                            ...
                            <div class="unsuccess show " id="stat1" style="background-color: rgb(255,204,203);  "  >
                                ...
                                <!-- <span id="xsign"class="cross"><i class="fa fa-times"></i></span> -->
                                    ...
                                    <!-- NOTIFICATION Invalid because of incorrect data -->
                            <div class="invalid show " id="stat2" style="background-color: rgb(255,204,203);  "  >
                                ...
                                <!-- <span id="xsign"class="cross"><i class="fa fa-times"></i></span> -->
                                     ...
                                     <!-- NOTIFICATION Invalid because of lack of data -->
                          ...
                          <!--⭐⭐⭐MODAL⭐⭐⭐-->
                                <!-- Batch Upload Modal -->
                        <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true"> <!-- ID needed to be change -->
                          <div class="modal-dialog" role="document">
                            <div class="modal-content">
                              ...
                              <form action="database/addformprocess.php" method="POST" enctype="multipart/form-data">
                                ...
                                <h1 id="referencenumbe1r" style="text-decoration:underline;" ><?php echo $_SESSION['Referencenum_mcur']?></h1>
                                        <label>Reference Number</label>
                                </div>
                                <!-- Note for batch upload and downloadable file -->
                                <div class="row margin" >
                                  <div style="margin-bottom:20px;padding-left:50px;margin-left:50px; border: 1px solid black;outline-style: solid;"class="col-lg-10">
                                    ...
                                    <div   id="attach" >
                                      ...
                                      <div class="input-size">
                                        <input type="file" accept=".csv, application/vnd.openxmlformats-officedocument.spreadsheetml.sheet, application/vnd.ms-excel"
                                         id="batchdata" style="padding-bottom:30px; " name="batch" class="form-control" >
                                      </div> 
                                    </div>
                                  </div>
                                  <!-- Requestor batch upload -->
                                  <div class="col-lg-6" >
                                    <div  id="remarks"  >
                                  ...
                                  <div class="col-lg-6" id="date1">
                                    ...
                                    <div class="input-group">
                                      ...
                                      <div class="input-size">
                                        <input class="form-control" style="width:100%;" name="date_requested" id="date_requestedmodal" onchange="date_validation()"  placeholder="YYYY/MM/DD" type="text"autocomplete="off"/>
                                      </div> 
                                    </div>  
                                  </div>
                                  <!-- date received batch upload -->
                                  <div class="col-lg-6" id="date2"  >
                                    ...
                                    <div class="input-group">
                                      ...
                                      <div class="input-size">
                                        <input class="form-control"  style="width:100%;" name="date_received" id="date_receivedmodal" onchange="date_validation()" placeholder="YYYY/MM/DD" type="text" autocomplete="off"/>
                                      </div> 
                                    </div>
                                  </div>
                                  <!-- date registered batch upload -->
                                  <div class="col-lg-6" id="date2"  >
                                    ...
                                    <div class="input-group">
                                      ...
                                      <div class="input-size">
                                        <input class="form-control"  style="width:100%;" id="date_registeredmodal" onchange="date_validation()" 
                                            name="date_registered" placeholder="YYYY/MM/DD" type="text" autocomplete="off"/>
                                      </div> 
                                    </div>
                                  </div>
                                  <!-- remarks batch upload -->
                                  <div class="col-lg-6" >
                                    <div  id="remarks"  >
                                      <label>Remarks :</label>
                                      <div class="input-size">
                                  ...
                                  <div class="col-lg-6" >
                                    <div   id="attach"  >
                                      ...
                                      <div class="input-size">
                                        <input type="file" id="inputattach1" accept="image/*,.pdf" style="padding-bottom:30px; " name="atta" class="form-control" >
                                      </div> 
                                    </div>
                                  </div>
                              </div><!-- row margin batch upload -->
                            </div><!-- modal-body batch upload -->
                            <div class="modal-footer">
                              <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                              <button type="submit" name="batch_upload" class="btn btn-primary"style="background:#008D61;">Submit</button>
                            </div>
                            </form><!-- end form batch upload -->
                          </div><!-- modal-content batch upload -->
                        </div><!-- modal-dialog batch upload -->
                      </div><!-- modal-fade batch upload -->
                              <!-- End Batch Upload Modal -->
                              <!-- Add new person Modal -->
                <div class="modal fade" id="modaladduser" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"  aria-hidden="true" > <!-- ID needed to be change -->
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      <div class="modal-header"style="background:#008D61;">
                        <h5 class="modal-title" id="exampleModalLabel" style="text-align:center; padding-top:10px; color:white;">ADD NEW PERSON</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                      </div><!-- modal-header add new person -->
                      <form action="database/addformprocess.php" method="POST" enctype="multipart/form-data">
                      <div class="modal-body">
                      <!-- name add new person -->
                      ...
                      </div><!-- modal-body add new person -->
                      <div class="modal-footer">
                        <button type="button" class="btn btn-danger btn-outline" data-dismiss="modal">Close</button>
                        <button type="submit" name="add_person" class="btn btn-primary"style="background:#008D61;">Save changes</button>
                      </div>
                      </form><!-- end form add new person -->
                    </div><!-- modal-content add new person -->
                  </div><!-- modal-dialog add new person -->
                </div><!-- modal-fade add new person -->
                            <!--Add new department -->
            <div class="modal fade" id="modaladddept" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" >
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  <div class="modal-header"style="background:#008D61;">
                    <h5 class="modal-title" id="exampleModalLabel" style="text-align:center; padding-top:10px;">ADD NEW DEPARTMENT</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"> <span aria-hidden="true">&times;</span></button>
                  </div><!-- modal-header add new department -->
                  <form action="database/addformprocess.php" method="POST" enctype="multipart/form-data">
                    <div class="modal-body">
                    ...
                    </div><!-- modal-body add new department -->
                    <div class="modal-footer">
                      <button type="button" class="btn btn-danger btn-outline" data-dismiss="modal">Close</button>
                      <button type="submit" name="add_department" class="btn btn-primary"style="background:#008D61;">Submit</button>
                    </div>
                  </form><!-- form add new department -->
                </div><!-- modal-content add new department -->
              </div><!-- modal-dialog add new department -->
             </div><!-- modal-fade add new department -->
                        <!--  Add new nature of request -->
              <div class="modal fade" id="modaladdnature" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" >
                <div class="modal-dialog" role="document">
                  <div class="modal-content">
                    <div class="modal-header"style="background:#008D61;">
                      <h5 class="modal-title" id="exampleModalLabel" style="text-align:center; padding-top:10px;">ADD NEW NATURE OF REQUEST</h5>
                      <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                    </div> <!-- modal-header add new nature of request -->
                    <form action="database/addformprocess.php" method="POST" enctype="multipart/form-data">
                    <div class="modal-body">
                    <!-- nature of reqeust add new nature of request -->
                      <div class="form-group">
                        <div   id="DEPT"  >
                          <label>Nature of Request :</label>
                            <div class="input-size">
                              <input type="text" id="nature" pattern="[A-Za-z0-9\s]+"  name="nature" title="Special Characters are not allowed in this field" class="form-control" required >
                            </div> 
                        </div>
                      </div>
                    </div><!-- modal-header add new nature of request -->
                    <div class="modal-footer">
                      <button type="button" class="btn btn-danger btn-outline" data-dismiss="modal">Close</button>
                      <button type="submit" name="add_nature" class="btn btn-primary"style="background:#008D61;">Save changes</button>
                    </div>
                    </form><!-- form add new nature of request -->
                  </div><!-- modal-content add new nature of request -->
              </div><!-- modal-dialog add new nature of request -->
             </div><!-- modal-fade add new nature of request -->
                    <!--⭐⭐⭐ Request Form  ⭐⭐⭐-->
    <div class="row ">
      <div class="myform col-sm-12" >
        <div class="wrapper1" id="wrap1">
          <!-- title for every form -->
            <div class="title1" id="DEF">REQUEST FORM</div>
            <div class="title1" id="qad_title" style="display:none;">QAD REQUEST</div>
            <div class="title1" id="lasys_title"style="display:none;">LASYS REQUEST</div>
            <div class="title1" id="nonlasys_title"style="display:none;">NON-LASYS REQUEST</div>
            <div class="title1" id="pad_title"style="display:none;">PAD REQUEST</div>
          ...
          <form action="database/addformprocess.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="col-lg-12 reference-num" style="text-align:center; margin-bottom:20px; margin-top:-20px; ">
              <div class="col-sm-10 ref-num">  
                  <h1 name="reference_number" id="referencenumber" style="text-decoration:underline;" >*-***-**-***</h1>
                  <label>Reference Number</label>
              </div><!-- end div of reference number*  -->
              <div class="col-sm-2" id="batch" style="margin-top:20px; color:grey; margin-left:-50px;display:none;">
                <div class="icon-list-demo">
                    <a data-toggle="modal" data-target="#exampleModal" ><span ><i class="fa fa-folder-open batch"  style="font-size:60px;color:grey;" ></i> </span><span style="color:grey;"> Batch Upload </span></a>
                </div> 
              </div><!-- end div of col-sm-2 -->
            </div><!-- end div col-lg-12 -->
              <!-- Request form content  -->
            <div class="col-lg-6"><!-- left part of the request form -->
              <label >Please select the applicable form: </label>   
              <div class="inputfield">
                <select class="form-control " name="selector" style="input:focus; border: 1px solid#008D61;" id="sel1" onchange="select()" required>
                ...
                <!-- requestor field of the request form -->
              <div id="requestor" class="margin">
                <label >Requestor : </label>   
                  ...
                  <!-- depeartment field of the request form -->
              <div id="department" class="margin">
                ...
                <div class="inputfield">
                  <select class="form-control " name="department" onchange="dept()"
                    ...
                    <?php // query to access data from database table deptansec         
                  ...
                  <!-- nature of request of field of the request form -->
              <div id="nor" class="margin" >
                ...
                <div class="inputfield">
                  <select class="form-control " id="inputnor"  name="nor" onchange="nature()"
                    ...
                    <!-- System username of field of the request form -->
              <div style="display:none" id="systemusername" class="margin">
                ...
                <div class="inputfield">
                  <input type="text" id="inputsysusername" name="sysusername" class="input" >
                    ...
                    <!-- System user of field of the request form -->
              <div style="display:none" id="systemuser" class="margin">
                ...
                <div class="inputfield">
                  <input type="text" id="inputsysuser" name="sysuser" class="input" >
                    ...
                    <!-- date requested and date received of the request form-->
              <div class="row margin" >
                  <!-- date requested field of the request form -->
                <div class="col-lg-6" id="date1">
                  <label>Date Requested :</label>
                  <div class="input-group">
                    <div class="input-group-addon">
                    ...
                    <div class="input-size">
                        <input class="form-control" style="width:100%;" id="inputdate10" name="daterequested" placeholder="YYYY/MM/DD" type="text"autocomplete="off"/>
                    </div> 
                  </div>  
                </div>
                  <!-- date received field of the request form -->
                <div class="col-lg-6" id="date2" >
                  <label>Date Received : </label>
                  <div class="input-group">
                    <div class="input-group-addon">
                    ...
                    <div class="input-size">
                        <input class="form-control"  style="width:100%;" id="inputdate20" name="datereceived" placeholder="YYYY/MM/DD" type="text" autocomplete="off"/>
                    </div> 
                  </div>
                </div>
              </div><!--end div of row-margin for date requested -->
                      <!-- details field of the request form -->
              <div id="details" class="margin" >
                <label style="padding-top:10px;">Details : </label>
                <div class="inputfield"   >
                  <textarea style="height:100px;" id="inputdetails" type="text" name="details" class="input" ></textarea>
                </div>  
              </div> 
            </div> <!-- end left part of the request form -->
                <!-- right part of the request form -->
            <div class="col-lg-6" >
                <!-- user type field of the request form -->
              <div style="display:none;" id="usertype">
                 ...
                 <!--date regitered field of the request form -->
              <div style="display:none;" id="datereg" class="margin" > 
                ...
                <div class="input-group">
                  ...
                  <div class="input-size">
                    <input class="form-control"  style="width:100%;" id="inputdatereg" name="inputdatereg" placeholder="YYYY/MM/DD" type="text" autocomplete="off"/>
                  </div> 
                </div>
              </div>
                  <!-- info card release date field of the request form -->
              <div style="display:none;" id="infocard" class="margin">
                ...
                <div class="input-group">
                  ...
                  <div class="input-size">
                    <input class="form-control"  style="width:100%;"  id="inputinfocard" name="infocard" placeholder="YYYY/MM/DD" type="text" autocomplete="off"/>
                  </div> 
                </div>
              </div>
                    <!-- reason for application field of the request form -->
              <div style="display:none;" id="reapp" class="margin" >
                ...
                <div class="inputfield">
                  ...
                  name="reasonforapp"  id="inputreapp" class="input"></textarea>
                    ...
                    <!-- date reset field of the request form -->
              <div style="display:none;" id="datereset" class="margin">
                ...
                <div class="input-group">
                  ...
                  <div class="input-size">
                    <input class="form-control"  style="width:100%;"  id="inputdatereset" name="datereset" placeholder="YYYY/MM/DD" type="text" autocomplete="off"/>
                  </div> 
               </div>
              </div>
                  <!-- date change field of the request form -->
              <div style="display:none;" id="datechan" class="margin">
                ...
                <div class="input-group">
                  ...
                  <div class="input-size">
                    <input class="form-control"  style="width:100%;"  id="inputdatechan"name="datecan" placeholder="YYYY/MM/DD" type="text" autocomplete="off"/>
                  </div> 
                </div>
              </div>
                  <!-- information field of the request form -->
              ...
              <div style="display:none;" id="impdate" class="margin">
                ...
                <div class="input-group">
                  ...
                  <div class="input-size">
                    <input class="form-control"  style="width:100%;"  id="inputimpdate" name="impdate" placeholder="YYYY/MM/DD" type="text" autocomplete="off"/>
                  </div> 
                </div>
              </div>
                    <!-- date approved and date done of the request form-->
                      <!-- calendar -->
              <div class="row">
                    <!-- date approved field of the request form -->
                <div class="col-lg-6" id="date3">
                  ...
                  <div class="input-group">
                    ...
                    <div class="input-size">
                      <input class="form-control"  style="width:100%;" id="inputdate3"name="dateapproved" placeholder="YYYY/MM/DD" type="text" autocomplete="off"/>
                    </div> 
                  </div>
                </div>
                    <!-- date done field of the request form -->
                <div class="col-lg-6" id="date4">
                  <label>Date done : </label>
                    <div class="input-group">
                      ...
                      <!-- end of date approved and date done of the request form-->
                      <!-- accomplished by field of the request form -->
              <div style="margin-top:15px;" id="accomp">
                ...
                <div class="inputfield">
                  <select class="form-control " name="accb" onchange="accomp()"
                    ...
                    <!-- remarks field of the request form -->
              <div class="margin" id="remarks">
                ...
                <div class="inputfield">
                  <input type="text"  name="remarks" id="inputremarks" class="input" >
                    ...
                    <!--Cancel/Delayed field of the request form -->
              <div class="margin" id="candel">
                ...
                <div class="inputfield">
                  <input type="text" id="inputcandel" name="canc" class="input" >
                    ...
                    <!--Attachment field of the request form -->
              <div class="margin" id="attach">
                ...
                <div class="inputfield">
                  <input type="file" id="inputattach"  name="atta" class="input" >
                    ...
                    <!--Submit Button of the request form -->
              <div class="col-lg-7" style="text-align:center; margin-left:80px;">
                <div class="inputfield"style="padding-top:30px; ">
                  <input type="submit" value="SUBMIT" accept="image/*,.pdf"  name="submit" class="fcbtn btn btn-outline btn-primary btn-1f">
                </div>
              </div>
            </div><!--** second col **-->
          </form><!-- form-->
  ...
  </div> <!-- div class="row" end requesyt form-->
  </div>
  </div>
</div>
        ...
        <script type="text/javascript" src="datepicker/datepicker.js"></script><!-- Date Picker JS-->
        <link rel="stylesheet" href="datepicker/datepicker.css"/><!-- Date Picker CSS-->
        <script type="text/javascript" src="js/toastr.js"></script><!-- Toast js -->
        <script type="text/javascript" src="js/jquery_toast.js"></script><!-- Jquery toast JS-->
        <script type="text/javascript" src="js/toaster.js"></script><!-- Toaster JS -->
        <link href="lib/toast-master/css/jquery.toast.css" rel="stylesheet"><!-- Toast CSS -->
<script>
function date_validation()
    {
      var date_requested = document.getElementById("date_requestedmodal");
      var date_received= document.getElementById("date_receivedmodal");
      var date_registered= document.getElementById("date_registeredmodal");
      if((date_received.value < date_requested.value ))
      {
        date_received.value ="YYYY/MM/DD";
        date_registered.value ="YYYY/MM/DD ";
        $.toast(
        {
          heading: 'Invalid Date',
          text: "The Date Received value should be greater than or equal Date Requested. ",
          position: 'top-right',
          loaderBg: '#ff6849',
          icon: 'warning',
          hideAfter: 4000,
      ...
      }else if((date_registered.value < date_received.value ))
      {
        date_registered.value ="YYYY/MM/DD";
        $.toast(
        {
          heading: 'Invalid Date',
          text: "The Date Registered value should be greater than or equal Date Requested and Date Received. ",
          position: 'top-right',
          loaderBg: '#ff6849',
          icon: 'warning',
          hideAfter: 6000,
    ...
    {
		var date_input=$('input[name="date_registered"]'); //our date input has the name "date"
  ...
  $(document).ready(function()
  {
		var date_input=$('input[name="date_requested"]'); //our date input has the name "date"
		var container=$('.bootstrap-iso form').length>0 ? $('.bootstrap-iso form').parent() : "body";
		date_input.datepicker(
    {
			format: 'yyyy/mm/dd',
...
<script>
        ...
        function select()
        {
          ...
          if(x=="QAD")
          {
            document.getElementById("referencenumber").innerHTML="<?php echo $_SESSION['Referencenum_qad']?>";
            ...
            document.getElementById("qad_title").style.display="";
            document.getElementById("lasys_title").style.display="NONE";
            document.getElementById("nonlasys_title").style.display="NONE";
            document.getElementById("pad_title").style.display="NONE";
          ...
          {//for lasys
            document.getElementById("referencenumber").innerHTML="<?php echo $_SESSION['Referencenum_las']?>";
            document.getElementById("inputrequestor").value="";
            document.getElementById("inputremarks").value="";
            document.getElementById("inputdepartment").value="";
            document.getElementById("inputnor").value="";
            ...
            document.getElementById("information").style.display="NONE";
            document.getElementById("impdate").style.display="NONE";
            document.getElementById("qad_title").style.display="NONE";
            document.getElementById("lasys_title").style.display="";
            document.getElementById("nonlasys_title").style.display="NONE";
            document.getElementById("pad_title").style.display="NONE";
            document.getElementById("DEF").style.display="NONE";
            document.getElementById("MCUR").style.display="NONE";
          ...
          {//for non lasys
            document.getElementById("referencenumber").innerHTML="<?php echo $_SESSION['Referencenum_non']?>";
            document.getElementById("inputrequestor").value="";
            document.getElementById("inputremarks").value="";
            document.getElementById("inputdepartment").value="";
            document.getElementById("inputnor").value="";
            ...
            document.getElementById("qad_title").style.display="NONE";
            document.getElementById("lasys_title").style.display="NONE";
            document.getElementById("nonlasys_title").style.display="";
            document.getElementById("pad_title").style.display="NONE";
            document.getElementById("DEF").style.display="NONE";
            document.getElementById("MCUR").style.display="NONE";
            document.getElementById("MCRC").style.display="NONE";
          ...
          {
            document.getElementById("referencenumber").innerHTML="<?php echo $_SESSION['Referencenum_pad']?>";
            document.getElementById("inputrequestor").value="";
            document.getElementById("inputremarks").value="";
            document.getElementById("inputdepartment").value="";
            document.getElementById("inputnor").value="";
            ...
            document.getElementById("lasys_title").style.display="NONE";
            document.getElementById("nonlasys_title").style.display="NONE";
            document.getElementById("pad_title").style.display="";
            document.getElementById("DEF").style.display="NONE";
            document.getElementById("MCUR").style.display="NONE";
            document.getElementById("MCRC").style.display="NONE";
            document.getElementById("MCRR").style.display="NONE";
          ...
          {
            document.getElementById("referencenumber").innerHTML="<?php echo $_SESSION['Referencenum_mcur']?>";
            document.getElementById("inputrequestor").value="";
            document.getElementById("inputremarks").value="";
            document.getElementById("inputdepartment").value="";
            document.getElementById("inputnor").value="";
          ...
          {
            document.getElementById("referencenumber").innerHTML="<?php echo $_SESSION['Referencenum_mcrc']?>";
            document.getElementById("inputrequestor").value="";
            document.getElementById("inputremarks").value=""; 
            document.getElementById("inputdepartment").value="";
            document.getElementById("inputnor").value="";
          ...
          {
            document.getElementById("referencenumber").innerHTML="<?php echo $_SESSION['Referencenum_mcrr']?>";
            document.getElementById("inputrequestor").value="";
            document.getElementById("inputremarks").value="";
            document.getElementById("inputdepartment").value="";
            document.getElementById("inputnor").value="";
          ...
          {
            document.getElementById("referencenumber").innerHTML="<?php echo $_SESSION['Referencenum_mcpr']?>";
            document.getElementById("inputrequestor").value="";
            document.getElementById("inputremarks").value="";
            document.getElementById("inputdepartment").value="";
            document.getElementById("inputnor").value="";
