<!DOCTYPE html>
<?php
    // Name of the module : activitylogs.php
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav slimscrollsidebar">
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li><a href="activitylogs.php" class="waves-effect active"><i class="mdi mdi-account-check"></i><span class="hide-menu">&emsp;Activity Logs</span></a></li>
	            ...
	            <span class="msg" style="font-size:13px"> Failed: Record not added!</span>
                  ...
                  <div class="row">
                                ...
                                <div class="col-sm-3">
                                    <div class="row">
                                        <div class="input-group">
                                            <input type="text" class="form-control" id="datepicker-autoclose" value="<?php echo date('F/Y')?>" onchange="tabledata()"> <span class="input-group-addon bg-info text-white"><i class="ti-calendar"></i></span> 
                                        </div>
                                    </div>
                                </div>
                            </div> 
