<!DOCTYPE html>
<?php
    // Name of the module : adminactivitylogs.php
                                ...
                                <thead>
                                    ...
                                    <tbody style="text-align:center;">
                                        ...
                                        <?php  
                                              ...
                                              $counter =0;                                  
                                              $sql = "SELECT * FROM [requestmonitoring].[dbo].[activitylogs] ORDER BY activitydate desc, activitytime desc,ID desc"; // sql for server
