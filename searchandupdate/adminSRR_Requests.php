                        ...
                        <div class="input-size" >
                          ...
                          value="<?php echo $row['datedone']?>" readonly/>
                              ...
                              <div class="form-group"style="padding: 0px 10px;">
                                            ...
                                            <div class="col-md-12">
                                                <input type="text" name="attachment" class="form-control form-control-line" value="<?php echo $row['attachment']?>"disabled> 
                                                <img src="../images/<?php echo $row['attachment']?>" alt="Terumo" style="width:80%" />
                                              </div>
                                            </div>
                                        </div><!-- Second Column -->
                        ...
                        <div class="input-size" >
                          ...
                          value="<?php echo $row['datedone']?>" />
                                ...
                                <div class="form-group"style="padding: 0px 10px;">
                                            <label class="col-md-12">Accomplished by: </label>
                                            <div class="col-md-12">
                                            <select  name="accomplishedby" 
                                            class="form-control form-control-line" id="inputaccomp" >
