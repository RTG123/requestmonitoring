...
<?php
    ...
    // Description : This module handles the update for Master Control Change and Cancellation for admin as a Usertype
                ...
                <div class="sidebar-nav slimscrollsidebar">
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <ul class="nav nav-second-level">
                                ...
                                <li> <a href="adminMCChange_Requests.php" class="waves-effect active"><span class="hide-menu">Mc Registration Change & Cancellation</span></a> </li>
          ...
          <div class="modal-content">
            ...
            <form action="database/updatedata.php" method="POST" enctype="multipart/form-data" class="form-material form-horizontal">
              <div class="modal-body">
                ...
                <div class="col-sm-6">
                  <!-- Reason for Application View Modal -->
                  <div class="form-group"style="padding: 0px 5px;">
                  ...
                  <!-- Date Change / Cancelled View Modal -->
                  <div style="display:;" class="form-group"style="padding: 10px 5px;">
                    <label class="col-md-12"> Date Change/Cancelled : </label>
                    <div class="col-md-12">
                        <input type="text" class="form-control form-control-line" value="<?php echo $row['datechangecancelled']?>"readonly> 
                    </div>
                  </div>
                  <!-- Remarks View Modal -->
            ...
            <div class="modal-body">
              <div class="row">
                <form action="../database/updateregistrationchange.php" method="POST" enctype="multipart/form-data" class="form-material form-horizontal">
                  ...
                  <div class="col-sm-6">
                     <!-- Reason for Application Edit Modal -->
                    <div class="form-group"style="padding: 0px 5px;">
                      <label class="col-md-12"> Reason for Application : </label>
                      <div class="col-md-12">
                        <input style="padding-left:20px;" class="form-control"  style="width:100%;" 
                    ...
                    <!-- Date Change/Cancelled Edit Modal -->
                    <div style="display:;" class="form-group"style="padding: 10px 5px;">
                      <label class="col-md-12"> Date Change/Cancelled : </label>
                      <div class="col-md-12">
      ...
      <div class="modal fade"  id="deletereportModal<?php echo $row['requestnumber']?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <div class="row">
                  <!-- Reference Number Delete Modal -->
                <form action="../database/admindelete.php" method="POST" enctype="multipart/form-data" class="form-material form-horizontal">
                  <div class="form-group"style="padding: 10px 100px;">
                    <div class="col-md-12">
                      <input type="text" name="request_num" class="form-control" style="text-align:center;font-size:35px;padding-bottom: 30px;padding-top:30px;"value="<?php echo $row['requestnumber']?>" readonly> 
                    </div>
                    <h5 class="col-md-12" id="references"style="text-align:center">Reference Number </h5>
                  </div>
                    <!-- Reference Number Delete Modal -->
                  <div class="col-sm-6">
                      <!-- Added by Delete Modal -->  
                    <div class="form-group"style="padding: 0px 5px;" >
                      <label class="col-md-12"> Added by: </label>
                      <div class="col-md-12">
                        <input  id="addedby0"  type="text" name="addedby" class="form-control form-control-line" value="<?php echo $row['userid']?>" readonly> 
                    ...
                    <div class="form-group"style="padding: 0px 5px;" >
                      ...
                      <!-- Department - Section Delete Modal -->
                    <div class="form-group"style="padding: 0px 5px;">
                      <label class="col-md-12"> Department - Section: </label>
                      <div class="col-md-12">
                        <input type="text" name="deptsect"  class="form-control form-control-line" value="<?php echo $row['department-section']?>"readonly> 
                  ...
                  <div class="col-sm-6">
                      <!-- Reason for Application Delete Modal -->
                    <div class="form-group"style="padding: 0px 5px;">
                      <label class="col-md-12"> Reason for Application : </label>
                      <div class="col-md-12">
                      <input style="padding-left:20px;" class="form-control"  style="width:100%;" 
                      ...
                      <!-- Date Change/Cancelled Delete Modal -->
                    <div style="display:;" class="form-group"style="padding: 10px 5px;">
                      <label class="col-md-12"> Date Change/Cancelled : </label>
                      <div class="col-md-12">
                        <input type="text" class="form-control form-control-line" value="<?php echo $row['datechangecancelled']?>"readonly> 
                              ...
                              <td>
                                <div class="row">
                                  <button type="button" class="btn btn-primary btn-xs dt-edit"style="background-color:#008D61;" >
                                    <a data-toggle="modal" data-target="#exampleModal<?php echo $row['requestnumber']?>" title="Edit Request" ><span class="glyphicon glyphicon-pencil " style="color:white"aria-hidden="true"></span></a>
                                  </button>
