<!DOCTYPE html>
<?php
  // Name of the module : MCChange_Requests.php
  ...
  require_once('../FOLDERS/SES/SESUSER.php'); //Connection Session for User Type.
                ...
                <form action="../database/updateregistrationchange.php" method="POST" enctype="multipart/form-data" class="form-material form-horizontal">
                      ...
                      <div class="col-md-12">
                        <select class="form-control form-control-line" name="deptsect"id="inputdepartment" >
                          ...
                          <?php    
                            ...
                            $sql2 = "SELECT DISTINCT(Department) FROM [requestmonitoring].[dbo].[deptandsec] WHERE NOT Department ='$deptvalue' "; 
                  ...
                  <div class="col-sm-6">
                    ...
                    <div class="form-group"style="padding: 0px 5px;">
                      ...
                      <!--Date Change/Cancelled Edit Report Modal -->
                    <div style="display:;" class="form-group"style="padding: 10px 5px;">
                      <label class="col-md-12"> Date Change/Cancelled : </label>
                      <div class="col-md-12">
          ...
          <div class="col-sm-12">
            <div style="background-color:white; padding:20px;" >
              <h3 class="box-title m-b-0" style="padding-bottom:15px;">Master Control Registration Change and Cancellation</h3>
                <!--Master Control Registration Table-->
