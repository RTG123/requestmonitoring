                ...
                <div class="sidebar-nav slimscrollsidebar">
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <ul class="nav nav-second-level">
                                ...
                                <li> <a href="MCRequest_Requests.php" class="waves-effect active"><span class="hide-menu">Mc Request Record</span></a> </li>
                            </ul>
                        </li>
                            ...
                            <form action="database/updatedata.php" method="POST" enctype="multipart/form-data" class="form-material form-horizontal">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="row margin" >
                                            <!-- Date Requeted View Report Modal -->
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group"style="padding: 0px 5px;">
                                        ...
                                        <div class="col-md-12">
                                         ...
                                         <!-- Implementation View Report Modal -->
