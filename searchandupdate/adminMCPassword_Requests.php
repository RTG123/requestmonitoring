<!DOCTYPE html>
<?php
    // Name of the module : adminMCChangeCancellation.php
    // Module creation date : 01/21/21
    // Author of the Module : Engr. Rian Canua
    // Revision History : Rev 0  == DONE
    // Description : This module handles the update for Master Password Change for admin as a Usertype
...
<html lang="en">
    ...
    <body class="fix-header" style="font-family:Century Gothic"onload="<?php echo $_SESSION['Confirmation'];?>">
     <!-- ⭐⭐⭐ HEADER & SIDE BAR ⭐⭐⭐ -->
        ...
        <div id="wrapper">
                ...
                <div class="sidebar-nav slimscrollsidebar">
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <ul class="nav nav-second-level">
                                ...
                                <li> <a href="adminMCPassword_Requests.php" class="waves-effect active"><span class="hide-menu">Mc Password Reset</span></a> </li>
                                <li> <a href="adminMCRequest_Requests.php" class="waves-effect "><span class="hide-menu">Mc Request Record</span></a> </li>
                            </ul>
                        </li>
                        <li><a href="../adminsactivitylogs.php" class="waves-effect"><i class="mdi mdi-account-check"></i><span class="hide-menu">&emsp;Activity Logs</span></a></li>
            ...
            <!-- ⭐⭐⭐ End header and side bar navigation ⭐⭐⭐ -->
                                ...
                                <form action="database/updatedata.php" method="POST" enctype="multipart/form-data" class="form-material form-horizontal">
                                  ...
                                  <div class="col-sm-6">
                                    ...
                                    <div class="form-group"style="padding: 0px 5px;">
                                      ...
                                      <div class="col-md-12">
                                        <input style="padding-left:20px;" class="form-control"  style="width:100%;" 
                                          ...
                                          value="<?php echo $row['reasonforapplication']?>" readonly/>
                                      </div>
                                    </div>
                                      <!-- Date Reset View Report Modal -->
                                    <div style="display:;" class="form-group"style="padding: 10px 5px;">
                                      <label class="col-md-12"> Date Reset: </label>
                                      <div class="col-md-12">
                                          <input type="text" class="form-control form-control-line" value="<?php echo $row['datereset']?>"readonly> 
                                      </div>
                                    </div> 
                                    ...
                                    <div class="form-group"style="padding: 0px 10px;">
                                      ...
                                      <!-- new Attachment View Report Modal -->
                                    <div class="form-group"style="padding: 0px 10px;">
      ...
      <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
          <div class="modal-header" style="background-color:#008d61">
            ...
            <div class="modal-body">
              <div class="row">
                <form action="../database/updatepassword.php" method="POST" enctype="multipart/form-data" class="form-material form-horizontal">
                  ...
                  <div class="col-sm-6">
                          <!-- Reason for Application Edit Report Modal -->
                    <div class="form-group"style="padding: 0px 5px;">
                      <label class="col-md-12"> Reason for Application : </label>
                      <div class="col-md-12">
                        <input style="padding-left:20px;" class="form-control"  style="width:100%;" 
                          ...
                          <!-- Date Reset Edit Report Modal -->
                    <div style="display:;" class="form-group"style="padding: 10px 5px;">
                      <label class="col-md-12"> Date Reset: </label>
                      <div class="col-md-12">
                          <input type="text" name="datereset" class="form-control form-control-line" value="<?php echo $row['datereset']?>"> 
                      </div>
                    </div> 
            ...
            <div class="modal-content">
                <div class="modal-header" style="background-color:#008d61">
                  ...
                  <div class="modal-body">
                      ...
                      <form action="../database/admindelete.php" method="POST" enctype="multipart/form-data" class="form-material form-horizontal">
                        ...
                        <div class="col-sm-6">
                          ...
                          <div class="form-group"style="padding: 0px 5px;">
                            ...
                            <!-- System Username Delete Report Modal -->
                          <div style="display:;" class="form-group"style="padding: 0px 5px;">
                            <label class="col-md-12"> System Username : </label>
                            <div class="col-md-12">
                                <input type="text" name="systemusername" class="form-control form-control-line" value="<?php echo $row['systemusername']?>"readonly> 
                          ...
                          <!-- System User Delete Report Modal -->
                          <div style="display:;" class="form-group"style="padding: 0px 5px;">
                            <label class="col-md-12"> System User : </label>
                            <div class="col-md-12">
                                <input type="text" name="systemuser" class="form-control form-control-line" value="<?php echo $row['systemuser']?>"readonly/> 
                        ...
                        <div class="col-sm-6">
                            <!-- Reason for Application Delete Report Modal -->
                          <div class="form-group"style="padding: 0px 5px;">
                            <label class="col-md-12"> Reason for Application : </label>
                            <div class="col-md-12">
                              <input style="padding-left:20px;" class="form-control"  style="width:100%;" 
                            ...
                            <!-- Date Reset Delete Report Modal -->
                          <div style="display:;" class="form-group"style="padding: 10px 5px;">
                            <label class="col-md-12"> Date Reset: </label>
                            <div class="col-md-12">
                                <input type="text" class="form-control form-control-line" value="<?php echo $row['datereset']?>"readonly> 
                          ...
                          <div class="form-group"style="padding: 0px 10px; display:none;">
                            ...
                            <!-- Confirm Password Delete Report Modal -->
                          <div class="form-group"style="padding: 0px 10px;">
                    ...
                    <div class="modal-footer">
                      <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>   
                      <input type="submit" value="Delete Data" style="background-color:#008d61;color:white;"  name="submit" class="fcbtn btn btn-outline btn-primary btn-1f">
                    </div>
                  </div>
                </form> <!-- form end-->
              </div>
        ...
        <div class="row ">
         <div class="col-sm-12">
            <div style="background-color:white; padding:20px;" > 
              <h3 class="box-title m-b-0" style="padding-bottom:15px;">Master Control Password Reset Request</h3>
              <div class="table-responsive" style="display:;"id="singletable">
                <table id="myTable5" class="table table-striped" style="overflow: hidden !important; margin-right:500px !important;" >                                   
                  ...
                  <tbody style="text-align:center;">
                    <?php  
                      $count=0;
                      $sql = "SELECT * FROM [requestmonitoring].[dbo].[mcpasswordrequest] ORDER BY ID DESC "; // sql for server
                      $stmt = sqlsrv_query( $conn, $sql ); 
                      while( $row = sqlsrv_fetch_array( $stmt, SQLSRV_FETCH_ASSOC) )
                      {
                      $count++;
    ...
    $(document).ready(function()
    {
      var date_input=$('input[name="datereset"]'); //our date input has the name "inputdatereg"
