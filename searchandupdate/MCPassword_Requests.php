<!DOCTYPE html>
<?php
  // Name of the module : MCPassword_Requests.php
  // Module creation date : 01/21/21
  // Author of the Module : Engr. Rian Canua
  // Revision History : Rev 0  == DONE
  // Description : This module handles the update for MC Password Request Request for admin as a Usertype
                ...
                <div class="sidebar-nav slimscrollsidebar">
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <ul class="nav nav-second-level">
                                ...
                                <li> <a href="MCPassword_Requests.php" class="waves-effect active"><span class="hide-menu">Mc Password Reset</span></a> </li>
        ...
        <div class="col-sm-12">
          <div style="background-color:white; padding:20px;" > 
            <h3 class="box-title m-b-0" style="padding-bottom:15px;">Master Control Password Reset Request</h3>
              <!--Master Contor Password request-->
