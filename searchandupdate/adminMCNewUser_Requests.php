            ...
            <nav class="navbar navbar-default navbar-static-top m-b-0">
                <div class="navbar-header">
                    ...
                    <ul class="nav navbar-top-links navbar-right pull-right">
                        <li class="dropdown">
                            <a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="#"> <iimg src="../images/<?php echo $_SESSION['profpic']?>" alt="user-img" width="36" class="img-circle"><b class="hidden-xs"><?php echo $_SESSION['firstname']?></b><span class="caret"></span> </a>
                        ...
                        <div class="modal-dialog modal-lg" role="document">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div style="display:;" class="form-group"style="padding: 10px 5px;">
                                                            ...
                                                            <div class="col-md-12">
                                                                <input type="text" name="dateregistered" class="form-control form-control-line" value="<?php echo $row['dateregistered']?>"readonly> 
                                                            </div>
                                                            </div> <!-- form group -->
                                ...
                                <div style="display:;" class="form-group"style="padding: 0px 5px;">
                                                            ...
                                                            <div class="col-md-12">
                                                                <input type="text" name="infocard" class="form-control form-control-line" value="<?php echo $row['infocard']?>"readonly> 
                                                            </div>
                                                            </div> <!-- form group -->
