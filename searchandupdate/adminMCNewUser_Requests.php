<!DOCTYPE html>
<?php
    // Name of the module : adminMCNewUser_Requests.php
    // Module creation date : 01/21/21
    // Author of the Module : Engr. Rian Canua
    // Revision History : Rev 0  == DONE
    // Description : This module handles the update for Master Control New User Registration for admin as a Usertype
...
<html lang="en">
            ...
            <nav class="navbar navbar-default navbar-static-top m-b-0">
                <div class="navbar-header">
                    ...
                    <ul class="nav navbar-top-links navbar-right pull-right">
                        <li class="dropdown">
                            <a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="#"> <iimg src="../images/<?php echo $_SESSION['Profile_pic']?>" alt="user-img" width="36" class="img-circle"><b class="hidden-xs"><?php echo $_SESSION['First_name']?></b><span class="caret"></span> </a>
                ...
                <div class="sidebar-nav slimscrollsidebar">
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <ul class="nav nav-second-level">
                                ...
                                <li> <a href="adminMCNewUser_Requests.php" class="waves-effect active"><span class="hide-menu">Mc New User Request</span></a> </li>
                                                ...
                                                <form action="database/updatedata.php" method="POST" enctype="multipart/form-data" class="form-material form-horizontal">
                                                    ...
                                                    <div class="col-sm-6">
                                                        ...
                                                        <div style="display:;" class="form-group"style="padding: 0px 5px;">
                                                            ...
                                                            <!-- System User View Modal -->
                                                        <div id="systemuser"style="display:;" class="form-group"style="padding: 0px 5px;">
                                                    ...
                                                    <!-- User Type View Modal -->
                                                    <div class="col-sm-6">
                                                        <div style="display:;" class="form-group"style="padding: 0px 5px;">
                                                            <label class="col-md-12"> User Type : </label>
                                                            <div class="col-md-12">
                                                                <input type="text" name="usertype" class="form-control form-control-line" value="<?php echo $row['usertype']?>"readonly> 
                                                            </div>
                                                        </div> 
                                                        <!-- Date Registered View Modal -->
                                                        <div style="display:;" class="form-group"style="padding: 10px 5px;">
                                                            <label class="col-md-12"> Date Registered : </label>
                                                            <div class="col-md-12">
                                                                <input type="text" class="form-control form-control-line" value="<?php echo $row['dateregistered']?>"readonly> 
                                                            </div>
                                                        </div> 
                                                            <!-- Info Card Releasse Date View Modal -->
                                                        <div style="display:;" class="form-group"style="padding: 0px 5px;">
                                                            <label class="col-md-12"> Info Card Release Date : </label>
                                                            <div class="col-md-12">
                                                                <input type="text" class="form-control form-control-line" value="<?php echo $row['infocard']?>"readonly> 
                                                            </div>
                                                        </div>
                                                        <!-- Remarks View Modal -->
                    ...
                    <div class="modal fade"  id="exampleModal<?php echo $row['requestnumber']?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-lg" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="row">
                                        <form action="../database/updatemcnewuser.php" method="POST" enctype="multipart/form-data" class="form-material form-horizontal">
                                                <!-- Reference Number Edit Modal -->
                                            <div class="form-group"style="padding: 10px 100px;">
                                                <div class="col-md-12">
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <div style="display:;" class="form-group"style="padding: 0px 5px;">
                                                    <label class="col-md-12"> User Type : </label>
                                                    <div class="col-md-12">
                                                        <input type="text" name="usertype" class="form-control form-control-line" value="<?php echo $row['usertype']?>"> 
                                                    </div>
                                                </div> 
                                                    <!-- Date Registered Edit Modal -->
                                                <div style="display:;" class="form-group"style="padding: 10px 5px;">
                                                    <label class="col-md-12"> Date Registered : </label>
                                                    <div class="col-md-12">
                                                        <input type="text" id="datetest" name="dateregistered" class="form-control form-control-line" value="<?php echo $row['dateregistered']?>"> 
                                                    </div>
                                                </div>
                                                    <!-- Info Card Reelase Date Edit Modal -->
                                                <div style="display:;" class="form-group"style="padding: 0px 5px;">
                                                    <label class="col-md-12"> Info Card Release Date : </label>
                                                    <div class="col-md-12">
                                                        <input type="text" name="infocard" class="form-control form-control-line" value="<?php echo $row['infocard']?>"> 
                                                    </div>
                                                </div>
                                                    <!-- Remarks Edit Modal -->
                                                <div class="form-group"style="padding: 0px 10px;">
                                ...
                                <div class="modal-body">
                                    <div class="row">
                                        <form action="../database/admindelete.php" method="POST" enctype="multipart/form-data" class="form-material form-horizontal">
                                                <!-- Reference Number Delete Report Modal Modal -->
                                            <div class="form-group"style="padding: 10px 100px;">
                                                <div class="col-md-12">
                                                    <input name="request_num" type="text" class="form-control form-control-line" style="text-align:center;font-size:35px;padding-bottom: 30px;padding-top:30px;"value="<?php echo $row['requestnumber']?>" readonly> 
                                                </div>
                                                <h5 class="col-md-12" id="references"style="text-align:center">Reference Number </h5>
                                            </div>
                                            <div class="col-sm-6">
                                                    <!-- Added by Delete Report Modal Modal -->
                                                <div class="form-group"style="padding: 0px 5px;" >
                                                    <label class="col-md-12"> Added by: </label>
                                                    <div class="col-md-12">
                                                        <input  id="addedby0"  type="text" name="addedby" class="form-control form-control-line" value="<?php echo $row['userid']?>" readonly> 
                                                    ...
                                                    <!-- Requestor Delete Report Modal Modal -->
                                                <div class="form-group"style="padding: 0px 5px;" >
                                                    <label class="col-md-12"> Requestor: </label>
                                                    <div class="col-md-12">
                                                        <input type="text" id="inputrequestor"  name="requestor" class="form-control form-control-line" value="<?php echo $row['requestor']?>"readonly> 
                                                    ...
                                                    <!-- Department - Section Delete Report Modal Modal -->
                                                <div class="form-group"style="padding: 0px 5px;">
                                                    <label class="col-md-12"> Department - Section: </label>
                                                    <div class="col-md-12">
                                                        <input type="text" name="deptsect"  class="form-control form-control-line" value="<?php echo $row['department-section']?>"readonly> 
                                                    ...
                                                    <!-- Systrm Username Delete Report Modal Modal -->
                                                <div style="display:;" class="form-group"style="padding: 0px 5px;">
                                                    <label class="col-md-12"> System Username : </label>
                                                    <div class="col-md-12">
                                                        <input type="text" name="systemusername" class="form-control form-control-line" value="<?php echo $row['systemusername']?>"readonly> 
                                                    ...
                                                    <!-- Syste User Delete Report Modal Modal -->
                                                <div id="systemuser"style="display:;" class="form-group"style="padding: 0px 5px;">
                                                    <label class="col-md-12"> System User : </label>
                                                    <div class="col-md-12">
                                                        <input type="text" name="systemuser" class="form-control form-control-line" value="<?php echo $row['systemuser']?>"readonly> 
                                                ...
                                                <div class="row margin" >
                                                   <!-- Date Requested Delete Report Modal Modal -->
                                                    <div class="col-lg-6" id="date1">
                                                        <label>Date Requested :</label>
                                                        <div class="input-group">
                                                            <div class="input-size">
                                                    ...
                                                    <!-- Date Received Delete Report Modal Modal -->
                                                    <div class="col-lg-6" id="date2" >
                                                        <label>Date Received : </label>
                                                        <div class="input-group">
                                                            <div class="input-size" >
                                            ...
                                            <div class="col-sm-6">
                                                    <!-- User Type Delete Report Modal Modal -->
                                                <div style="display:;" class="form-group"style="padding: 0px 5px;">
                                                    <label class="col-md-12"> User Type : </label>
                                                    <div class="col-md-12">
                                                        <input type="text" name="usertype" class="form-control form-control-line" value="<?php echo $row['usertype']?>"readonly> 
                                                    ...
                                                    <!-- Date Registered Delete Report Modal Modal -->
                                                <div style="display:;" class="form-group"style="padding: 10px 5px;">
                                                    <label class="col-md-12"> Date Registered : </label>
                                                    <div class="col-md-12">
                                                        <input type="text" class="form-control form-control-line" value="<?php echo $row['dateregistered']?>"readonly> 
                                                    ...
                                                    <!-- Infocard Release Date Delete Report Modal Modal -->
                                                <div style="display:;" class="form-group"style="padding: 0px 5px;">
                                                    <label class="col-md-12"> Info Card Release Date : </label>
                                                    <div class="col-md-12">
                                                        <input type="text" class="form-control form-control-line" value="<?php echo $row['infocard']?>"readonly> 
                                                    ...
                                                    <!-- Remarks Delete Report Modal Modal -->
                                                <div class="form-group"style="padding: 0px 10px;">
                                                    <label class="col-md-12">Remarks : </label>
                                                    <div class="col-md-12">
                                                        <input type="text" name="remarks"   class="form-control form-control-line" value="<?php echo $row['remarks']?>"readonly> 
                                                    ...
                                                    <!--Date Processed Delete Report Modal Modal -->
                ...
                <section class="wrapper">
                    ...
                    <div class="row ">
                        <div class="col-sm-12">
                            ...
                            <h3 class="box-title m-b-0" style="padding-bottom:15px;">Master Control New User Registration</h3>
                                <div class="table-responsive" style="display:;"id="singletable">
                                    <table id="myTable5" class="table table-striped" style="overflow: hidden !important; margin-right:500px !important;" >                                   
                                        ...
                                        <tbody style="text-align:center;">
                                            <?php  
                                                $count=0;
                                                $sql = "SELECT DISTINCT requestnumber,userid, requestor, attachment FROM [requestmonitoring].[dbo].[mcnewuser] ORDER BY requestnumber DESC  "; // sql for server
                                                $stmt = sqlsrv_query( $conn, $sql ); 
                                                while( $row = sqlsrv_fetch_array( $stmt, SQLSRV_FETCH_ASSOC) )
                                                {
                                                    $count++; 
    ...
    $(document).ready(function()
    {
        var date_input=$('input[name="dateregistered"]'); //our date input has the name "inputdatereg"
    ...
    $(document).ready(function()
    {
        var date_input=$('input[name="infocard"]'); //our date input has the name "inputdatereg"
        var container=$('.bootstrap-iso form').length>0 ? $('.bootstrap-iso form').parent() : "body";
        date_input.datepicker(
        {
			format: 'yyyy/mm/dd',
