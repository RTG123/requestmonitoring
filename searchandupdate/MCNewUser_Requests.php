<!DOCTYPE html>
<?php
    // Name of the module : MCNewUser_Request.php
    // Module creation date : 01/21/21
    // Author of the Module : Engr. Rian Canua
    // Revision History : Rev 0  == DONE
    // Description : This module handles the update for MC Change Registration and Cancellation Request for admin as a Usertype
                ...
                <div class="sidebar-nav slimscrollsidebar">
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <ul class="nav nav-second-level">
                                ...
                                <li> <a href="MCNewUser_Requests.php" class="waves-effect active"><span class="hide-menu">Mc New User Request</span></a> </li>
                        ...
                        <li><a href="../activitylogs.php" class="waves-effect"><i class="mdi mdi-account-check"></i><span class="hide-menu">&emsp;Activity Logs</span></a>
                        </li>
                        ...
                        <form action="database/updatedata.php" method="POST" enctype="multipart/form-data" class="form-material form-horizontal">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div style="display:;" class="form-group"style="padding: 10px 5px;">
                                    ...
                                    <!--Info Card Release Date View Report Modal -->
                                <div style="display:;" class="form-group"style="padding: 0px 5px;">
                            ...
                            <form action="../database/updatemcnewuser.php" method="POST" enctype="multipart/form-data" class="form-material form-horizontal">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group"style="padding: 0px 5px;" >
                                        ...
                                        <!-- Department-Section Edit Report Modal -->
                                    <div class="form-group"style="padding: 0px 5px;">
                                        <label class="col-md-12"> Department - Section: </label>
                                        <div class="col-md-12">
                                        ...
                                        <!-- System Username Edit Report Modal -->
                                    <div style="display:;" class="form-group"style="padding: 0px 5px;">
                                        <label class="col-md-12"> System Username : </label>
                                        <div class="col-md-12">
                                            <input type="text" name="systemusername" class="form-control form-control-line" value="<?php echo $row['systemusername']?>" readonly> 
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div style="display:;" class="form-group"style="padding: 0px 5px;">
                                        ...
                                        <!-- Date Registered Edit Report Modal -->
                                    <div style="display:;" class="form-group"style="padding: 10px 5px;">
                                        <label class="col-md-12"> Date Registered : </label>
                                        <div class="col-md-12">
                                            <input type="text" id="datetest" name="dateregistered" class="form-control form-control-line" autocomplete="off" value="<?php echo $row['dateregistered']?>"> 
                                        </div>
                                    </div> 
                                        <!--Info Card release date Edit Report Modal -->
                                    <div style="display:;" class="form-group"style="padding: 0px 5px;">
                                        <label class="col-md-12"> Info Card Release Date : </label>
                                        <div class="col-md-12">
                                            <input type="text" name="infocard" autocomplete="off" class="form-control form-control-line" value="<?php echo $row['infocard']?>"> 
                                        </div>
                                    </div>
