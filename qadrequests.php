            ...
            <nav class="navbar navbar-default navbar-static-top m-b-0">
                <div class="navbar-header">
                    ...
                    <ul class="nav navbar-top-links navbar-right pull-right">
                        <li class="dropdown">
                            <a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="#"> <img src="images/user-default.png" alt="user-img" width="36" class="img-circle"><b class="hidden-xs">FirstName</b><span class="caret"></span> </a>
                                ...
                                <li>
                                    <div class="dw-user-box">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="u-text">
                                                    <p style="font-size:14px">FirstName LastName</p>
                                                    <p class="text-muted"><small>Usertype</small></p>
                ...
                <div class="sidebar-nav slimscrollsidebar">
                    ...
                    <div class="user-profile">
                        <div class="dropdown user-pro-body">
                            ...
                            <h5 style="font-family:Century Gothic">FirstName LastName<br><small>Usertype</small></h5>
                        </div>
                    </div>
                    <ul class="nav" id="side-menu">
                        ...
                        <li><a href="javascript:void(0)" class="waves-effect"><i class="mdi mdi-face fa-fw"></i><span class="hide-menu">&emsp;Search and Update<span class="fa arrow"></span></span></a>
                            <ul class="nav nav-second-level">
                                <li> <a href="connection.php" class="waves-effect "><i class="fa-fw">F</i><span class="hide-menu">Font awesome</span></a> </li>
                                <li> <a href="qadrequests.php" class="waves-effect active"><i class="fa-fw">T</i><span class="hide-menu">Qad Requests</span></a> </li>
                            </ul>
                        </li>
