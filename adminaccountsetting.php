<!DOCTYPE html>
<?php
    // Name of the module : adminaccountsettings.php
    // Module creation date : 02/10/21
    // Author of the Module : Rian Canua
    // Revision History : Rev 0  == DONE
    // Description : This module handles the setting page for admin as usertype
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane  active" id="settings">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                             <div class="col-md-11">
                                                <input type="password" placeholder="Password" class="form-control form-control-line" minlength="7"  id="password-field1" name="newpass_word" >
                                                </div>
                                              <div class="col-md-1">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                              <div class="col-md-11">
                                                <input type="password" placeholder="Confirm Password" class="form-control form-control-line" minlength="7"  id="password-field2" name="confirmpass_word" >
                                                </div>
                                              <div class="col-md-1">
                                 ...
                                 <div class="tab-pane" id="register">
                                    <form class="form-horizontal form-material" method="POST" action="database/registration.php" name="updateForm" onsubmit="return validateForm()" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <label class="col-sm-12">Section - Department</label>
                                            <div class="col-sm-12">
                                                    <select class="form-control form-control-line " name="section_department"  required>
                                                        <option value="">Select</option>
                                                        <?php          
