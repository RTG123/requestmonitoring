                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane  active" id="settings">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                             <div class="col-md-11">
                                                <input type="password" placeholder="Password" class="form-control form-control-line" minlength="8"  id="password-field1" name="newpass_word" >
                                                </div>
                                              <div class="col-md-1">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                              <div class="col-md-11">
                                                <input type="password" placeholder="Confirm Password" class="form-control form-control-line" minlength="8"  id="password-field2" name="confirmpass_word" >
                                                </div>
                                              <div class="col-md-1">
